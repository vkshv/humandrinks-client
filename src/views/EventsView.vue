<template>
  <div class="events-view">
    ...
    <div class="soon">
      <div class="soon__title">скоро</div>
      <div class="soon__list">
        <div
          v-for="item in soonEventItems"
          :key="item.documentId"
          class="soon__item"
          @click="itemModalStore.openEvent(item)"
        >
          <div
            class="soon__item-img"
            :style="{ backgroundImage: `url(${config.STRAPI_URL + item.picture})` }"
          >
            <div
              v-if="item.almostFull"
              class="soon__item-almost-full"
            >мало мест</div>
          </div>
          <div class="soon__item-title">
            {{ item.title }}
          </div>
          <div class="soon__item-date">
    ...
    <div class="items">
      <div class="items__title">все</div>
        ...
        >
          ...
          >
            <div class="item__tags">
              <div v-if="item.almostFull" class="item__tag">мало мест</div>
            </div>
          </div>
